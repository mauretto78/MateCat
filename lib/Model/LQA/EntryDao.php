...
";
     ...
     * @throws \Exception
     */
    public function getByJobIdSourcePageAndIdSegment( $id_job, $source_page, $id_segment ) {

        $sql = "SELECT * FROM qa_entries WHERE id_job = :id_job AND deleted_at IS NULL AND id_segment = :id_segment AND source_page = :source_page";
